...
nonisolated public struct OpenAICreateImageRequestBody: Encodable, Sendable {
    ...
    /// Use `OpenAIService.streamingCreateImageRequest` rather than setting this
    /// flag manually — the streaming method will set it for you.
    /// Only supported by gpt-image-1, gpt-image-1-mini, gpt-image-1.5 and gpt-image-2.
    public var stream: Bool?

    /// Number of partial images to emit while the final image is rendering, 0–3.
    /// Defaults to 0. Requires `stream = true`. Only supported by the
    /// gpt-image family of models.
