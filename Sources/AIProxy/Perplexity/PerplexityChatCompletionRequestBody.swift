...
extension PerplexityChatCompletionRequestBody {
    nonisolated public struct WebSearchOptions: Encodable, Sendable {
        ...
        public let imageSearchRelevanceEnhanced: Bool?

        private enum CodingKeys: String, CodingKey {
            case searchContextSize = "search_context_size"
            case imageSearchRelevanceEnhanced = "image_search_relevance_enhanced"
        }

        public init(
            searchContextSize: SearchContextSize,
            imageSearchRelevanceEnhanced: Bool? = nil
        ) {
            self.searchContextSize = searchContextSize
            self.imageSearchRelevanceEnhanced = imageSearchRelevanceEnhanced
        }
    }
